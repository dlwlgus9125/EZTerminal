...
[![Release](https://img.shields.io/badge/release-v1.0.42-brightgreen)](https://github.com/dlwlgus9125/EZTerminal/releases/latest)
...
[Read the release notes](docs/release/release-notes-1.0.42.md) ·
...
The current stable release is **v1.0.42**.

| Platform | Supported system | Release asset |
| --- | --- | --- |
| Windows desktop | Windows 10 22H2 or Windows 11, x64 | `EZTerminal-Setup.exe` |
| Android companion | Android 10 / API 29 or newer | `EZTerminal-Android-1.0.42-vc63.apk` |
...
> [!IMPORTANT]
> The v1.0.42 Windows installer is published unsigned while the SignPath Foundation application is
...
| Current release | [v1.0.42 notes](docs/release/release-notes-1.0.42.md) · [1.0.42 validation policy](docs/release/validation-policy-1.0.42.md) |
