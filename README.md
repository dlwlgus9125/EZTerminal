...
[![Release](https://img.shields.io/badge/release-v1.0.53-brightgreen)](docs/release/release-notes-1.0.53.md)
...
[Review the v1.0.53 release candidate](docs/release/release-notes-1.0.53.md) ·
...
The current release candidate is **v1.0.53**. It targets a draft GitHub Release;
...
| Android companion | Android 10 / API 29 or newer | `EZTerminal-Android-1.0.53-vc74.apk` |
...
> [!IMPORTANT]
> The v1.0.53 Windows installer candidate is unsigned while the SignPath Foundation application is
...
| Current release candidate | [v1.0.53 notes](docs/release/release-notes-1.0.53.md) · [1.0.53 validation policy](docs/release/validation-policy-1.0.53.md) |
