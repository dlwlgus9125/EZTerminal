...
![release](https://img.shields.io/badge/release-v1.0.16-brightgreen)
...
closed without disabling terminal-only remote access. In 1.0.16, frame
...
- Android 10 (API 29) or newer: `EZTerminal-Android-1.0.16-vc37.apk`
...
[1.0.16 validation policy](docs/release/validation-policy-1.0.16.md).
...
Secure-desktop and Ctrl+Alt+Delete support are not included in 1.0.16.
