...
![release](https://img.shields.io/badge/release-v1.0.23-brightgreen)
...
closed without disabling terminal-only remote access. In 1.0.23, frame
...
Secure-desktop and Ctrl+Alt+Delete support are not included in 1.0.23.
