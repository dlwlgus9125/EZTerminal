...
![release](https://img.shields.io/badge/release-v1.0.14-brightgreen)
...
closed without disabling terminal-only remote access. In 1.0.14, frame
...
- Android 10 (API 29) or newer: `EZTerminal-Android-1.0.14-vc35.apk`
...
[1.0.14 validation policy](docs/release/validation-policy-1.0.14.md).
...
Secure-desktop and Ctrl+Alt+Delete support are not included in 1.0.14.
