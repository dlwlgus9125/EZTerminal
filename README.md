...
closed without disabling terminal-only remote access. In 1.0.7, frame
...
- Android 10 (API 29) or newer: `EZTerminal-Android-1.0.7-vc28.apk`
...
[1.0.7 validation policy](docs/release/validation-policy-1.0.7.md).
...
Secure-desktop and Ctrl+Alt+Delete support are not included in 1.0.7.
