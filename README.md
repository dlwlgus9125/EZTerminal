...
closed without disabling terminal-only remote access. In 1.0.6, frame
...
- Android 10 (API 29) or newer: `EZTerminal-Android-1.0.6-vc27.apk`
...
[1.0.6 validation policy](docs/release/validation-policy-1.0.6.md).
...
Secure-desktop and Ctrl+Alt+Delete support are not included in 1.0.6.
