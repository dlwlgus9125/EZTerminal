...
closed without disabling terminal-only remote access. In 1.0.8, frame
...
- Android 10 (API 29) or newer: `EZTerminal-Android-1.0.8-vc29.apk`
...
[1.0.8 validation policy](docs/release/validation-policy-1.0.8.md).
...
Secure-desktop and Ctrl+Alt+Delete support are not included in 1.0.8.
