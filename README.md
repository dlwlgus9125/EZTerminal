...
[![Release](https://img.shields.io/badge/release-v1.0.50-brightgreen)](docs/release/release-notes-1.0.50.md)
...
[Review the v1.0.50 release candidate](docs/release/release-notes-1.0.50.md) ·
[Open published releases](https://github.com/dlwlgus9125/EZTerminal/releases) ·
...
The current release candidate is **v1.0.50**. It targets a draft GitHub Release;
public distribution requires a separate approval.

| Platform | Supported system | Release asset |
| --- | --- | --- |
| Windows desktop | Windows 10 22H2 or Windows 11, x64 | `EZTerminal-Setup.exe` |
| Android companion | Android 10 / API 29 or newer | `EZTerminal-Android-1.0.50-vc71.apk` |

Release reviewers must inspect both artifacts, `release-manifest.json`, and
`SHA256SUMS.txt` in the draft before any separate publication decision.

> [!IMPORTANT]
> The v1.0.50 Windows installer candidate is unsigned while the SignPath Foundation application is
...
| Current release candidate | [v1.0.50 notes](docs/release/release-notes-1.0.50.md) · [1.0.50 validation policy](docs/release/validation-policy-1.0.50.md) |
