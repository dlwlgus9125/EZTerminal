...
Release identity: remote protocol v6, Android versionCode 38.

This release supersedes the unpublished 1.0.15 and 1.0.16 candidates. Their
immutable tags remain attached to their original commits and were not reused.
...
- Android 10 (API 29) or newer:
  `EZTerminal-Android-1.0.17-vc38.apk`
...
See the [1.0.17 validation policy](validation-policy-1.0.17.md).
