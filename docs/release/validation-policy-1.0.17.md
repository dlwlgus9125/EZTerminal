# EZTerminal 1.0.17 validation policy and residual risk

## Release identity

- Desktop, Android, and native-host product version: `1.0.17`
...
The tagged 1.0.14, 1.0.15, and 1.0.16 identities and their documentation are
...
Release 1.0.17 therefore uses the `functional-hotfix` profile and does not
