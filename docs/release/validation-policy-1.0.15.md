# EZTerminal 1.0.15 validation policy and residual risk

## Release identity

- Desktop, Android, and native-host product version: `1.0.15`
...
The tagged 1.0.14 identity and its protocol-v5 documentation are immutable.
...
Release 1.0.15 therefore uses the `functional-hotfix` profile and does not
