# EZTerminal 1.0.16 validation policy and residual risk

## Release identity

- Desktop, Android, and native-host product version: `1.0.16`
...
The tagged 1.0.14 and 1.0.15 identities and their documentation are immutable.
...
Release 1.0.16 therefore uses the `functional-hotfix` profile and does not
