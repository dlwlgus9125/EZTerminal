# EZTerminal 1.0.44 validation policy and residual risk

## Release identity

- Desktop, Android and native-host product version: `1.0.44`
...
1.0.44 candidate must be built from one exact clean Git SHA.
...
- upgrading from v1.0.41 repairs an installed supervisor with an explicit empty
  ...
  readable;
- the ACL regression test and recovery hashing use Windows PowerShell 5.1/.NET
  APIs and do not require optional PowerShell Security or Utility modules;
...
or soak claim is made for 1.0.44.
