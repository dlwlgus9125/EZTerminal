...
> Current for the **v1.0.46 release candidate** (2026-09-04).
...
- [`agent-collaboration.md`](design/agent-collaboration.md)
...
- [`validation-policy-1.0.46.md`](release/validation-policy-1.0.46.md)
...
- 현재 release 검증 정책의 저장소 경로는
  `docs/release/validation-policy-1.0.46.md`이다.
