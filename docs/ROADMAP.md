...
> Current for the **v1.0.50 release candidate** (2026-09-07).
...
- [`validation-policy-1.0.50.md`](release/validation-policy-1.0.50.md)
...
- 현재 release 검증 정책의 저장소 경로는
  `docs/release/validation-policy-1.0.50.md`이다.
