...
export {
  DOCK_PANEL_COMPONENTS as DETACHABLE_PANEL_COMPONENTS,
  isDetachableDockPanelComponent as isDetachablePanelComponent,
  type DockPanelComponent as DetachablePanelComponent,
} from './dock-panel-capabilities';
